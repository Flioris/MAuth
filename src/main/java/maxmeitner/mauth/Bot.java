...
import maxmeitner.mauth.confirmMessage.ConfirmMessage;
import maxmeitner.mauth.confirmMessage.ConfirmMessageCache;
import maxmeitner.mauth.confirmMessage.ConfirmMessageType;
import maxmeitner.mauth.db.Core;
import maxmeitner.mauth.event.SuccessAuthEvent;
import maxmeitner.mauth.listener.DiscordListener;
import maxmeitner.mauth.util.BlockedUsersCache;
...
public class Bot {
    ...
    public static void startBot(String token) {
        ...
        verifiedRole = mainGuild.getRoleById(ConfigHandler.getString("discord.role-id"));
