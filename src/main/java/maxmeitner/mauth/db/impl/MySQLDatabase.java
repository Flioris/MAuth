...
public class MySQLDatabase implements IDatabase {
    ...
    public MySQLDatabase(String host, int port, String database, String user, String password) {
        ...
        try (Connection cn = this.connect(); Statement st = cn.createStatement()){
            st.executeUpdate("CREATE TABLE IF NOT EXISTS accounts (id INTEGER AUTO_INCREMENT PRIMARY KEY, player TEXT NOT NULL, did TEXT NOT NULL)");
            st.executeUpdate("CREATE TABLE IF NOT EXISTS sessions (id INTEGER AUTO_INCREMENT PRIMARY KEY, player TEXT NOT NULL, ip TEXT NOT NULL)");
            st.executeUpdate("CREATE TABLE IF NOT EXISTS whitelist (id INTEGER AUTO_INCREMENT PRIMARY KEY, ip TEXT NOT NULL)");
